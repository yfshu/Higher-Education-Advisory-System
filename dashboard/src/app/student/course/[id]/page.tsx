...
export default function ProgramDetail() {
  ...
  const program = {
    ...
    reviews: 456,
    matchPercentage: 95,
    description: 'Our Computer Science degree program is designed to provide students with a comprehensive understanding of computer science principles and practical skills relevant to Malaysia\'s growing tech industry. The curriculum covers software engineering, algorithms, artificial intelligence, data structures, and emerging technologies with strong industry partnerships.',
    tags: ['Programming', 'AI/ML', 'Software Engineering', 'Data Structures', 'Industry Partners'],
    requirements: {
      academic: 'SPM: 5 credits including Mathematics and English OR STPM: CGPA 3.0 OR Diploma in related field',
      english: 'SPM English: Credit OR MUET Band 3 OR IELTS 5.5',
      experience: 'No prior programming experience required',
      other: 'Interview may be required for certain applicants'
    },
    curriculum: [
      { year: 1, subjects: ['Programming Fundamentals (C++/Java)', 'Mathematics for Computer Science', 'Digital Logic Design', 'Introduction to Software Engineering', 'Computer Organization'] },
      { year: 2, subjects: ['Data Structures & Algorithms', 'Database Systems', 'Computer Networks', 'Web Development', 'Operating Systems'] },
      { year: 3, subjects: ['Artificial Intelligence', 'Software Engineering Project', 'Computer Graphics', 'Mobile Application Development', 'Cybersecurity Fundamentals'] },
      { year: 4, subjects: ['Machine Learning', 'Distributed Systems', 'Industrial Training (6 months)', 'Final Year Project', 'Professional Ethics in Computing'] }
    ],
    facilities: [
      'Modern computer labs with latest software',
      '24/7 access to development environments',
      'Industry-standard software licenses (Microsoft, Oracle, Adobe)',
      'High-speed internet and cloud computing resources',
      'Smart classrooms and lecture halls',
      'Maker space for hardware projects',
      'Library with extensive digital resources'
    ],
    careerOutcomes: [
      { role: 'Software Developer', percentage: 40 },
      { role: 'System Analyst', percentage: 18 },
      { role: 'Data Analyst/Scientist', percentage: 15 },
      { role: 'IT Consultant', percentage: 12 },
      { role: 'Project Manager', percentage: 8 },
      { role: 'Further Studies/Research', percentage: 7 }
    ],
    employmentStats: {
      employmentRate: 94,
      averageSalary: 4200,
      graduateSatisfaction: 91
    },
    contact: {
      admissions: '+603-7967 3063',
