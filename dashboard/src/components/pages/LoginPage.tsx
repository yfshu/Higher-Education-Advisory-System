...
export default function LoginPage() {
  ...
  // Function to determine if user is admin based on email
  const isAdminEmail = (email: string): boolean => {
    return email.includes('admin') || email.endsWith('@backtoschool.admin.my');
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate login process with account type detection
    setTimeout(() => {
