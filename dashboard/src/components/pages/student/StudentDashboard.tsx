...
export default function StudentDashboard() {
  ...
  const savedPrograms = [
    ...
    { title: 'Cybersecurity', university: 'Universiti Kebangsaan Malaysia', saved: '1 week ago' },
      ...
      <div className="space-y-8">
        ...
        <div className="backdrop-blur-xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-white/20 rounded-2xl p-8">
          ...
          <p className="text-gray-600 mb-6">
            Your personalized Malaysian university program recommendations are ready. Let's continue exploring the perfect program that matches your SPM/STPM results and career aspirations.
          </p>
          <div className="flex gap-4">
            ...
            <Link to="/student/search">
              <Button variant="outline" className="backdrop-blur-sm bg-white/50 border-blue-300 text-blue-600 hover:bg-blue-50">
                Explore Programs
              </Button>
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <Card className="p-6 backdrop-blur-xl bg-white/40 border-white/20 shadow-lg">
            ...
            <p className="text-sm text-gray-500 mt-2">Programs & scholarships</p>
          </Card>
